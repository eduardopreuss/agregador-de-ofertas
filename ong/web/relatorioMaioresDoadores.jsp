...
<html>
    <head>
        ...
        <title>Relatórios - Maior Doador</title>
    </head>
    <body>
        ...
        <div class="col-md-9">
            ...
            <br>
            <br>
            <label>Retorna as pessoas que efetuaram a maior quantidade de doações no período. (Período padrão 30 dias) </label>
            </br>
            </br>
            <form method="post" action="RelatorioServlet?acao=MaioresDoadores">
                <div class="col-md-6">
                    <div class="col-md-5">
                ...
                <input class="btn btn-default" type='submit' value='Gerar Relatório' name='btnMaioresDoadores'>
                </div>
            </form>
            </br>
            <div id="maiorDoador">
