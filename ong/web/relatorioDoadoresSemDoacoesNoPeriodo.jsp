...
<html>
    <head>
        ...
        <title>Relatórios - Doadores sem Doações no Período</title>
    </head>
    <body>
        ...
        <div class="col-md-9">
            ...
            <br>
            <br>
            <label>Lista o nome e data da última doação daqueles doadores que não efetuaram doações no período. (Período padrão 30 dias) </label>
            </br>
            </br>
            <form method="post" action="RelatorioServlet?acao=DoadoresSemDoacoes">
                <div class="col-md-6">
                    <div class="col-md-5">
                ...
                <input class="btn btn-default" type='submit' value='Gerar Relatório' name='btnDoadoresSemDoacoes'>
                </div>
            </form>
            </br>            
            <div id="doadoresQueNaoEfetuaramDoacao">
